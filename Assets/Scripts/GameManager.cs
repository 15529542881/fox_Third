...
public class GameManager : MonoBehaviour
{
    ...
    void PickUpJiangGuo(GameObject jiangGuoObj)
    {
        ...
        taskXiongText.text = "Bear – Collect Berries (" + jiangGuoNum + "/5)";
    ...
    {
        killNum++;
        taskTuziText.text = "Rabbit – Pop the Balloons (" + killNum + "/3)";
        if (killNum >= 3)
        {
            planState[1] = 3;
            qiQiuObjs.SetActive(false);
    ...
    void PickUpStone(GameObject stoneObj)
    {
        ...
        stoneCount++;
        bagControl.AddStone();        
        taskHuanXiongText.text = "Raccoon – Trade for Fireworks (" + stoneCount + "/5)";
    ...
    void ExchangeFirework()
    {
        ...
        taskHuanXiongText.text = "Raccoon – Trade for Fireworks(5/5)";
